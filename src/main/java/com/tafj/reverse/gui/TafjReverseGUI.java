...
public class TafjReverseGUI {
    ...
    private static final Pattern KEYWORDS = Pattern.compile(
        ...
        "CRT|DELETE|SELECT|READNEXT|READPREV|CLEAR|RELEASE|MATREAD|" +
        "MATWRITE|MATREADU|MATWRITEU|COPY|MOVE|INSERT|DELETE|REPLACE|SPLIT|" +
        "FIELD|CHANGE|COUNT|FIND|FINDSTR|LOCATE|CALLJ|CALLJEE|" +
        "SEARCH|SORT|ENCRYPT|DECRYPT|USING|REPEAT|" +
